...
class Channel_videos_ft extends EE_Fieldtype
{
	...
	public function display_field($data)
	{
		...
		$this->EE->channel_videos_helper->addMcpAssets('css', 'css/colorbox.css?v='.CHANNEL_VIDEOS_VERSION, 'jquery', 'colorbox');
        $this->EE->channel_videos_helper->addMcpAssets('css', 'css/pbf.css?v='.CHANNEL_VIDEOS_VERSION, 'channel_videos', 'pbf');
        $this->EE->channel_videos_helper->addMcpAssets('js', 'js/jquery.colorbox.js?v='.CHANNEL_VIDEOS_VERSION, 'jquery', 'colorbox');
        $this->EE->channel_videos_helper->addMcpAssets('js', 'js/json3.min.js?v='.CHANNEL_VIDEOS_VERSION, 'json3', 'json3', 'lte IE 8');

        if ($this->EE->config->item('channel_videos_debug') == 'yes') {
             $this->EE->channel_videos_helper->addMcpAssets('js', 'js/pbf.js?v='.CHANNEL_VIDEOS_VERSION, 'channel_videos', 'pbf');
        } else {
             $this->EE->channel_videos_helper->addMcpAssets('js', 'js/pbf.min.js?v='.CHANNEL_VIDEOS_VERSION, 'channel_videos', 'pbf');
        }
	...
	public function display_settings($data)
	{
		...
		$this->EE->table->add_row('ACT URL', '<a href="'.$this->EE->channel_videos_helper->getRouterUrl().'" target="_blank">'.$this->EE->channel_videos_helper->getRouterUrl().'</a>');
	}
