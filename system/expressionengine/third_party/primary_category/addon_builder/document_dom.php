...
class documentDOM_primary_category {
	...
	function documentDOM_primary_category()
	{
	...
	/* END documentDOM_primary_category() */
    ...
    {
    	$obj = new createElement_primary_category($name, $attributes);
    	return $obj;
	}
	/* END */
...
class createElement_primary_category extends documentDOM_primary_category
{
	var $element	= '';
	...
	function createElement_primary_category($name, $attributes = array())
	{
		if ($name == '') return;
