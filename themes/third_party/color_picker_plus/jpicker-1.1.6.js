        ...
        function()
        {
          ...
          var isLessThanIE7 = parseFloat(navigator.appVersion.split('MSIE')[1]) < 7 && document.body.filters, // needed to run the AlphaImageLoader function for IE6
			...
			qcResetClicked =
			  function()
			  {
					if (settings.color.quickListDefault && settings.color.quickListDefault.length > 0 && settings.cansavechanges=='y')
					{
						settings.updateurl = settings.updateurl.replace("&amp;", "&");
						defaultsToPass = '';
						for (i = 0; i < settings.color.quickListDefault.length; i++)
						{
							/* if default colors are hex strings, change them to color objects */
							if ((typeof (settings.color.quickListDefault[i])).toString().toLowerCase() == 'string') color.quickListDefault[i] = new Color({ hex: settings.color.quickListDefault[i] });
							var alpha = settings.color.quickListDefault[i].val('a');
							var ahex = settings.color.quickListDefault[i].val('ahex');
							if (!settings.window.alphaSupport && ahex) ahex = ahex.substring(0, 6) + 'ff';
							if (ahex == null) ahex = '';
							var quickHex = settings.color.quickListDefault[i].val('hex');	                
							itxt = '';
							if (i<10) {
								itxt = '0' + i;
							} else {
							...
							$('span[name="qc' + itxt + '"]').attr('title', '#' + ahex)
								.attr('style', function() {
									var return_str = '';
									if (quickHex == '' || quickHex == null) {
										return_str = 'background-image:url(' + images.clientPath + 'NoColor.png)';
									} else {
										return_str = 'background-color:#' + quickHex;
									}
									return return_str;
								});
							defaultsToPass = defaultsToPass + quickHex + ',';
						}
						defaultsToPass = defaultsToPass.substr(0, defaultsToPass.length - 1);
            ...
            quickPickClicked =
              function(e)
              {
                e.preventDefault();
                e.stopPropagation();
				if (e.shiftKey && settings.cansavechanges=='y') {
					document.getSelection().removeAllRanges();
					// change the color: and title:
					alpha = ColorMethods.intToHex( color.active.val('a') );
					hx = $($this).val();
					// save to preferences
            ...
            initialize =
              function()
              {
                ...
                var controlHtml='<table class="jPicker" cellpadding="0" cellspacing="0"><tbody>' + (win.expandable ? '<tr><td class="Move" colspan="5">&nbsp;</td></tr>' : '') + '<tr><td rowspan="9"><h2 class="Title">' + (win.title || localization.text.title) + '</h2><div class="Map"><span class="Map1">&nbsp;</span><span class="Map2">&nbsp;</span><span class="Map3">&nbsp;</span><img src="' + images.clientPath + images.colorMap.arrow.file + '" class="Arrow"/></div></td><td rowspan="9"><div class="Bar"><span class="Map1">&nbsp;</span><span class="Map2">&nbsp;</span><span class="Map3">&nbsp;</span><span class="Map4">&nbsp;</span><span class="Map5">&nbsp;</span><span class="Map6">&nbsp;</span><img src="' + images.clientPath + images.colorBar.arrow.file + '" class="Arrow"/></div></td><td colspan="2" class="Preview">' + localization.text.newColor + '<div><span class="Active" title="' + localization.tooltips.colors.newColor + '">&nbsp;</span><span class="Current" title="' + localization.tooltips.colors.currentColor + '">&nbsp;</span></div>' + localization.text.currentColor + '</td><td rowspan="9" class="Button"><input type="button" class="Ok submit" value="' + localization.text.ok + '" title="' + localization.tooltips.buttons.ok + '"/><input type="button" class="Cancel" value="' + localization.text.cancel + '" title="' + localization.tooltips.buttons.cancel + '"/><hr/>' + (settings.canreset == 'y' ? '<input type="button" class="qcReset" value="' + localization.text.qcReset + '" title ="' + localization.tooltips.buttons.qcReset + '" /><div class="reset-copy">' + localization.text.shiftClick + '</div>' : '') + '<div class="Grid">&nbsp;</div></td></tr><tr class="Hue"><td class="Radio"><label title="' + localization.tooltips.hue.radio + '"><input type="radio" value="h"' + (settings.color.mode == 'h' ? ' checked="checked"' : '') + '/>H:</label></td><td class="Text"><input type="text" class="jPickerValue" maxlength="3" value="' + (all != null ? all.h : '') + '" title="' + localization.tooltips.hue.textbox + '"/>&nbsp;&deg;</td></tr><tr class="Saturation"><td class="Radio"><label title="' + localization.tooltips.saturation.radio + '"><input type="radio" value="s"' + (settings.color.mode == 's' ? ' checked="checked"' : '') + '/>S:</label></td><td class="Text"><input type="text" class="jPickerValue" maxlength="3" value="' + (all != null ? all.s : '') + '" title="' + localization.tooltips.saturation.textbox + '"/>&nbsp;%</td></tr><tr class="Value"><td class="Radio"><label title="' + localization.tooltips.value.radio + '"><input type="radio" value="v"' + (settings.color.mode == 'v' ? ' checked="checked"' : '') + '/>V:</label><br/><br/></td><td class="Text"><input type="text" class="jPickerValue" maxlength="3" value="' + (all != null ? all.v : '') + '" title="' + localization.tooltips.value.textbox + '"/>&nbsp;%<br/><br/></td></tr><tr class="Red"><td class="Radio"><label title="' + localization.tooltips.red.radio + '"><input type="radio" value="r"' + (settings.color.mode == 'r' ? ' checked="checked"' : '') + '/>R:</label></td><td class="Text"><input type="text" class="jPickerValue" maxlength="3" value="' + (all != null ? all.r : '') + '" title="' + localization.tooltips.red.textbox + '"/></td></tr><tr class="Green"><td class="Radio"><label title="' + localization.tooltips.green.radio + '"><input type="radio" value="g"' + (settings.color.mode == 'g' ? ' checked="checked"' : '') + '/>G:</label></td><td class="Text"><input type="text" class="jPickerValue" maxlength="3" value="' + (all != null ? all.g : '') + '" title="' + localization.tooltips.green.textbox + '"/></td></tr><tr class="Blue"><td class="Radio"><label title="' + localization.tooltips.blue.radio + '"><input type="radio" value="b"' + (settings.color.mode == 'b' ? ' checked="checked"' : '') + '/>B:</label></td><td class="Text"><input type="text" class="jPickerValue" maxlength="3" value="' + (all != null ? all.b : '') + '" title="' + localization.tooltips.blue.textbox + '"/></td></tr><tr class="Alpha"><td class="Radio">' + (win.alphaSupport ? '<label title="' + localization.tooltips.alpha.radio + '"><input type="radio" value="a"' + (settings.color.mode == 'a' ? ' checked="checked"' : '') + '/>A:</label>' : '&nbsp;') + '</td><td class="Text">' + (win.alphaSupport ? '<input type="text" class="jPickerValue" maxlength="' + (3 + win.alphaPrecision) + '" value="' + (all != null ? Math.precision((all.a * 100) / 255, win.alphaPrecision) : '') + '" title="' + localization.tooltips.alpha.textbox + '"/>&nbsp;%' : '&nbsp;') + '</td></tr><tr class="Hex"><td colspan="2" class="Text"><label title="' + localization.tooltips.hex.textbox + '">#:<input type="text" maxlength="6" class="jPickerValue Hex" value="' + (all != null ? all.hex : '') + '"/></label>' + (win.alphaSupport ? '<input type="text" class="jPickerValue" maxlength="2" class="AHex" value="' + (all != null ? all.ahex.substring(6) : '') + '" title="' + localization.tooltips.hex.alpha + '"/></td>' : '&nbsp;') + '</tr></tbody></table>';
                  ...
                  container.css( // positions must be set and display set to absolute before source code injection or IE will size the container to fit the window
                    {
                      left:
                        ...
                        win.position.x == 'middle' ? (($(window).width() - 545) / 2) + 'px' :
                      ...
                      top: win.position.y == 'top' ? (popup.offset().top - 312) + 'px' :
                           ...
                           win.position.y == 'middle' ? (($(window).height() - 360) / 3) + 'px' :
				...
				qcResetButton = button.find('.qcReset:first').bind('click', qcResetClicked);
                ...
                if (color.quickList && color.quickList.length > 0)
                {
                  ...
                  for (i = 0; i < color.quickList.length; i++)
                  {
                    ...
                    html+='<span name="qc' + itxt + '" class="QuickColor"' + (ahex && ' title="#' + ahex + '"' || '') + ' style="background-color:' + (quickHex && '#' + quickHex || '') + ';' + (quickHex ? '' : 'background-image:url(' + images.clientPath + 'NoColor.png)') + (win.alphaSupport && alpha && alpha < 255 ? ';opacity:' + Math.precision(alpha / 255, 4) + ';filter:Alpha(opacity=' + Math.precision(alpha / 2.55, 4) + ')' : '') + '">&nbsp;</span>';
                  }
      ...
      window:
        {
          ...
          position:
          {
            ...
            x: 'middle', /* acceptable values "left", "center", "right", "screenCenter", or relative px value */
            y: 'middle' /* acceptable values "top", "bottom", "center", or relative px value */
          },
      ...
      color:
        {
          ...
          active: new Color({ ahex: '#cc00ff' }), /* acceptable values are any declared $.jPicker.Color object or string HEX value (e.g. #ffc000) WITH OR WITHOUT the "#" prefix */
          ...
          quickListDefault: /* the quick pick color list defaults*/
            [
              new Color({ h: 360, s: 33, v: 100 }), /* acceptable values are any declared $.jPicker.Color object or string HEX value (e.g. #ffc000) WITH OR WITHOUT the "#" prefix */
              new Color({ h: 360, s: 66, v: 100 }),
              new Color({ h: 360, s: 100, v: 100 }),
      ...
      localization: /* alter these to change the text presented by the picker (e.g. different language) */
        {
          text:
          {
            ...
            ok: 'OK',
            cancel: 'Cancel',
			shiftClick: 'Shift + click in any color box to save new color',
			qcReset: 'Reset to defaults'
          },
          tooltips:
          {
            colors:
            ...
            buttons:
            {
			  ...
			  qcReset : 'Reset Quick Pick colors to defauts set in the Control Panel'
            },
            hue:
            {
...
$(document).ready(function(){
  $(".jPicker span.Image").click(function() {
      if (!($('#picker-overlay').length)) {
        $("body").append("<div id='picker-overlay' style='background: rgba(0,0,0,.4); z-index:5; width:100%; height: 100%; position: fixed; top: 0;'></div>")
      }
  });
});